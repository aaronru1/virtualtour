...
// Filename: 2060 VR Skin.ggsk
// Generated 2021-02-12T17:21:24
...
function pano2vrSkin(player,base) {
	...
	me.callChildLogicBlocksHotspot_ht_downstairs_mouseover = function(){
		if(hotspotTemplates['ht_downstairs']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_downstairs'].length; i++) {
				if (hotspotTemplates['ht_downstairs'][i]._image_1 && hotspotTemplates['ht_downstairs'][i]._image_1.logicBlock_alpha) {
					hotspotTemplates['ht_downstairs'][i]._image_1.logicBlock_alpha();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_upstairs_mouseover = function(){
		if(hotspotTemplates['ht_upstairs']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_upstairs'].length; i++) {
				if (hotspotTemplates['ht_upstairs'][i]._image_2 && hotspotTemplates['ht_upstairs'][i]._image_2.logicBlock_alpha) {
					hotspotTemplates['ht_upstairs'][i]._image_2.logicBlock_alpha();
				}
			}
		}
	}
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
		...
		hs+='width : 200px;';
		hs+='pointer-events:auto;';
		hs+='transform:translate3d(0px,0px,-3px);';
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
...
this.__div.style.top = vs.height / 2 + "px";
	...
	function SkinHotspotClass_ht_downstairs(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_downstairs=document.createElement('div');
		el.ggId="ht_downstairs";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_downstairs.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			if (me.hotspot.url!='' && me.hotspot.url.charAt(0)=='{') { // }
		...
		me._ht_downstairs.onclick=function (e) {
			player.openNext(me.hotspot.url,"$(cur)");
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_downstairs.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_downstairs.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._ht_downstairs.onmouseout=function (e) {
			player.setActiveHotspot(null);
			skin.hotspotProxyOut(me.hotspot.id, me.hotspot.url);
		}
		me._ht_downstairs.ggUpdatePosition=function (useTransition) {
		}
		...
		me._ht_downstairs.appendChild(me._image_1);
		me.ggUse3d=true;
		me.gg3dDistance=750;
		me.__div = me._ht_downstairs;
	};
	function SkinHotspotClass_ht_upstairs(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_upstairs=document.createElement('div');
		el.ggId="ht_upstairs";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_upstairs.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			if (me.hotspot.url!='' && me.hotspot.url.charAt(0)=='{') { // }
		...
		me._ht_upstairs.onclick=function (e) {
			player.openNext(me.hotspot.url,"$(cur)");
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_upstairs.ondblclick=function (e) {
			skin.hotspotProxyDoubleClick(me.hotspot.id, me.hotspot.url);
		}
		me._ht_upstairs.onmouseover=function (e) {
			player.setActiveHotspot(me.hotspot);
			skin.hotspotProxyOver(me.hotspot.id, me.hotspot.url);
		}
		me._ht_upstairs.onmouseout=function (e) {
			player.setActiveHotspot(null);
			skin.hotspotProxyOut(me.hotspot.id, me.hotspot.url);
		}
		me._ht_upstairs.ggUpdatePosition=function (useTransition) {
		}
		...
		me._ht_upstairs.appendChild(me._image_2);
		me.ggUse3d=true;
		me.gg3dDistance=750;
		me.__div = me._ht_upstairs;
	};
	me.addSkinHotspot=function(hotspot) {
		...
		if (hotspot.skinid=='ht_downstairs') {
			hotspot.skinid = 'ht_downstairs';
			hsinst = new SkinHotspotClass_ht_downstairs(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_ht_downstairs_mouseover();;
		} else
		{
			hotspot.skinid = 'ht_upstairs';
			hsinst = new SkinHotspotClass_ht_upstairs(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_ht_upstairs_mouseover();;
		}
		return hsinst;
	}
	me.removeSkinHotspots=function() {
		...
		if(hotspotTemplates['ht_downstairs']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_downstairs'].length; i++) {
				hotspotTemplates['ht_downstairs'][i] = null;
			}
		}
		if(hotspotTemplates['ht_upstairs']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_upstairs'].length; i++) {
				hotspotTemplates['ht_upstairs'][i] = null;
			}
		}
		hotspotTemplates = [];
	}
	...
	player.addListener('mouseover', function(args) { me.callChildLogicBlocksHotspot_ht_downstairs_mouseover();me.callChildLogicBlocksHotspot_ht_upstairs_mouseover(); });
